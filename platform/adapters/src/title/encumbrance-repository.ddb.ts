/**
 * EncumbranceRepository - DynamoDB Implementation
 *
...
/**
 * EncumbranceRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Encumbrance repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { EncumbranceRepository } from "@provenara/services/title";
...
/**
 * EncumbranceRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ENCUMBRANCE
 * Entity Token: ENCUMBRANCE
 * SK Prefix: ENCUMBRANCE
 */
export class EncumbranceRepositoryDdb implements EncumbranceRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ENCUMBRANCE";
  private readonly ENTITY_TOKEN = "ENCUMBRANCE";
  private readonly SK_PREFIX = "ENCUMBRANCE";
  ...
  private readonly ENTITY_TYPE_PK = "ENCUMBRANCES";
