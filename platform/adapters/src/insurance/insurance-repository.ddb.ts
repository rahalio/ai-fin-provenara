/**
 * InsuranceRepository - DynamoDB Implementation
 *
...
/**
 * InsuranceRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Insurance repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { InsuranceRepository } from "@provenara/services/insurance";
...
/**
 * InsuranceRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: INSURANCE_POLICY
 * Entity Token: INSURANCE_POLICY
 * SK Prefix: INSURANCE_POLICY
 */
export class InsuranceRepositoryDdb implements InsuranceRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "INSURANCE_POLICY";
  private readonly ENTITY_TOKEN = "INSURANCE_POLICY";
  private readonly SK_PREFIX = "INSURANCE_POLICY";
  ...
  private readonly DOMAIN = "INSURANCE";
  private readonly ENTITY_TYPE_PK = "INSURANCE_POLICIES";
  private generateCorrelationId(): string {
    const domainPrefix = "ins";
