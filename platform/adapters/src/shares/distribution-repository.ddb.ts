/**
 * DistributionRepository - DynamoDB Implementation
 *
...
/**
 * DistributionRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Distribution repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { DistributionRepository } from "@provenara/services/shares";
...
/**
 * DistributionRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: DISTRIBUTION
 * Entity Token: DISTRIBUTION
 * SK Prefix: DISTRIBUTION
 */
export class DistributionRepositoryDdb implements DistributionRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "DISTRIBUTION";
  private readonly ENTITY_TOKEN = "DISTRIBUTION";
  private readonly SK_PREFIX = "DISTRIBUTION";
  ...
  private readonly ENTITY_TYPE_PK = "DISTRIBUTIONS";
