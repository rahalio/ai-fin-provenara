/**
 * TrustFileRepository - DynamoDB Implementation
 *
...
/**
 * TrustFileRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing TrustFile repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { TrustFileRepository } from "@provenara/services/artworks";
...
/**
 * TrustFileRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: TRUST_FILE
 * Entity Token: TRUST_FILE
 * SK Prefix: TRUST_FILE
 */
export class TrustFileRepositoryDdb implements TrustFileRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "TRUST_FILE";
  private readonly ENTITY_TOKEN = "TRUST_FILE";
  private readonly SK_PREFIX = "TRUST_FILE";
  ...
  private readonly ENTITY_TYPE_PK = "TRUST_FILES";
