 ...
 *
 * DDD: Infrastructure adapter implementing Provenance repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ProvenanceRepository } from "@provenara/services/provenance";
...
/**
 * ProvenanceRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: PROVENANCE_EVENT
 * Entity Token: PROVENANCE_EVENT
 * SK Prefix: PROVENANCE_EVENT
 */
export class ProvenanceRepositoryDdb implements ProvenanceRepository {
  ...
  private readonly ENTITY_TYPE = "PROVENANCE_EVENT";
  private readonly ENTITY_TOKEN = "PROVENANCE_EVENT";
  private readonly SK_PREFIX = "PROVENANCE_EVENT";
  ...
  private readonly ENTITY_TYPE_PK = "PROVENANCE_EVENTS";
