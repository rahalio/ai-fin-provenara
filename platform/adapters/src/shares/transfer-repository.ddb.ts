/**
 * TransferRepository - DynamoDB Implementation
 *
...
/**
 * TransferRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Transfer repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { TransferRepository } from "@provenara/services/shares";
...
/**
 * TransferRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: TRANSFER
 * Entity Token: TRANSFER
 * SK Prefix: TRANSFER
 */
export class TransferRepositoryDdb implements TransferRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "TRANSFER";
  private readonly ENTITY_TOKEN = "TRANSFER";
  private readonly SK_PREFIX = "TRANSFER";
  ...
  private readonly ENTITY_TYPE_PK = "TRANSFERS";
