/**
 * Counterparties Services - Application Layer Export
 *
...
/**
 * Counterparties Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for counterparties domain.
 */
