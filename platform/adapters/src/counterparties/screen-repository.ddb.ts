/**
 * ScreenRepository - DynamoDB Implementation
 *
 ...
 * ScreenRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Screen repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ScreenRepository } from "@provenara/services/counterparties";
...
/**
 * ScreenRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: SCREEN_RESULT
 * Entity Token: SCREEN_RESULT
 * SK Prefix: SCREEN_RESULT
 */
export class ScreenRepositoryDdb implements ScreenRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "SCREEN_RESULT";
  private readonly ENTITY_TOKEN = "SCREEN_RESULT";
  private readonly SK_PREFIX = "SCREEN_RESULT";
  ...
  private readonly ENTITY_TYPE_PK = "SCREEN_RESULTS";
