/**
 * DocumentRepository - DynamoDB Implementation
 *
...
/**
 * DocumentRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Document repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { DocumentRepository } from "@provenara/services/provenance";
...
/**
 * DocumentRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: DOCUMENT_ARTEFACT
 * Entity Token: DOCUMENT_ARTEFACT
 * SK Prefix: DOCUMENT_ARTEFACT
 */
export class DocumentRepositoryDdb implements DocumentRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "DOCUMENT_ARTEFACT";
  private readonly ENTITY_TOKEN = "DOCUMENT_ARTEFACT";
  private readonly SK_PREFIX = "DOCUMENT_ARTEFACT";
  ...
  private readonly DOMAIN = "PROVENANCE";
  private readonly ENTITY_TYPE_PK = "DOCUMENT_ARTEFACTS";
  private generateCorrelationId(): string {
    const domainPrefix = "prv";
