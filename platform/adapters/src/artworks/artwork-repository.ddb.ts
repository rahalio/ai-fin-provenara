/**
 * ArtworkRepository - DynamoDB Implementation
 *
...
/**
 * ArtworkRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Artwork repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ArtworkRepository } from "@provenara/services/artworks";
...
/**
 * ArtworkRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ARTWORK
 * Entity Token: ARTWORK
 * SK Prefix: ARTWORK
 */
export class ArtworkRepositoryDdb implements ArtworkRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ARTWORK";
  private readonly ENTITY_TOKEN = "ARTWORK";
  private readonly SK_PREFIX = "ARTWORK";
  ...
  private readonly DOMAIN = "ARTWORKS";
  private readonly ENTITY_TYPE_PK = "ARTWORKS";
  private generateCorrelationId(): string {
    const domainPrefix = "art";
