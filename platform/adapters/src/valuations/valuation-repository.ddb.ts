/**
 * ValuationRepository - DynamoDB Implementation
 *
...
/**
 * ValuationRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Valuation repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ValuationRepository } from "@provenara/services/valuations";
...
/**
 * ValuationRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: VALUATION_MARK
 * Entity Token: VALUATION_MARK
 * SK Prefix: VALUATION_MARK
 */
export class ValuationRepositoryDdb implements ValuationRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "VALUATION_MARK";
  private readonly ENTITY_TOKEN = "VALUATION_MARK";
  private readonly SK_PREFIX = "VALUATION_MARK";
  ...
  private readonly DOMAIN = "VALUATIONS";
  private readonly ENTITY_TYPE_PK = "VALUATION_MARKS";
  private generateCorrelationId(): string {
    const domainPrefix = "val";
